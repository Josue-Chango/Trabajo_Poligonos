    ...
    public partial class FrmOctagono : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            if (Validador.Validar<int>(txtRadio.Text))
            {
                ...
                dibujar = true;
                lblArea.Text = "Area: " + calculos.CalcularAreaOctagono(radio);
                lblPerimetro.Text = "Perimetro: " + calculos.CalcularPerimetroOctagono(radio);
                Invalidate();
        ...
        private void pctGrafico_Paint(object sender, PaintEventArgs e)
        {
            ...
            figuras.DibujarOctagono(g, radio);
        }
