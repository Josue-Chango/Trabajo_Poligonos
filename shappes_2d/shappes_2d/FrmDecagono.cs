...
namespace shappes_2d
{
    public partial class FrmDecagono : Form
    {
        ...
        private void pctGrafico_Paint(object sender, PaintEventArgs e)
        {
            ...
            figuras.DibujarDecagono(g, radio);
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            if (Validador.Validar<int>(txtRadio.Text))
            {
                ...
                dibujar = true;
                lblArea.Text = "Area: " + calculos.CalcularAreaDecagono(radio);
                lblPerimetro.Text = "Perimetro: " + calculos.CalcularPerimetroDecagono(radio);
                Invalidate();
